            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 col-xl-3">
                ...
                <div class="tm-footer-content-box">
                    ...
                    <div class="tm-margin-b-30">
                        ...
                        <img src={{ asset('/img/tm-img-100x100-2.jpg') }} class="tm-footer-thumbnail">
                        <img src={{ asset('/img/tm-img-100x100-3.jpg') }} class="tm-footer-thumbnail">
                        <img src={{ asset('/img/tm-img-100x100-4.jpg') }} class="tm-footer-thumbnail">
                        <img src={{ asset('/img/tm-img-100x100-5.jpg') }} class="tm-footer-thumbnail">
                        <img src={{ asset('/img/tm-img-100x100-6.jpg') }} class="tm-footer-thumbnail">
                    </div>
